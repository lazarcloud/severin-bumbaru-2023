    ...
    for i in range(30):
     for comb in input_combinations:
          if comb[2]==0:
               ...
               pref_dir=True
               pref_not_on=True
     train_search.best_train(start_station=all_stations[comb[0]],end_station=all_stations[comb[0]],prefer_no_changes=pref_dir,prefer_not_overnight=pref_not_on,dep_date=time.time())
